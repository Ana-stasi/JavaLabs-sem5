...
<head>
    <title><fmt:message key="edit.label.edit_product"/></title>
</head>
<body>
<div class="page-form">
    <form action="${pageContext.request.contextPath}/edit" method="post">
        <h2><fmt:message key="edit.label.edit_product"/></h2>
        <p class="hint-text"><fmt:message key="user.label.dont_remember"/> <a href="${pageContext.request.contextPath}/catalogue"> <fmt:message key="label.catalogue"/></a></p>
        <div class="form-group">
            <input type="text" class="form-control" name="product_id" placeholder="<fmt:message key="label.product_number"/>" required="required">
        </div>
