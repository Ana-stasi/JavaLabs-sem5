        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
                <ul class="nav navbar-nav navbar-left">
                    <li><a href ="#"><span class="glyphicon"></span ><fmt:message key="admin.menubar.label.product"/>:</a></li>
                </ul>
                <ul class="nav navbar-nav navbar-left">
                    <li><a href="${pageContext.request.contextPath}/add"><span class="glyphicon"></span><fmt:message key="admin.menubar.label.add"/></a></li>
                </ul>
                <ul class="nav navbar-nav navbar-left">
                    <li><a href="${pageContext.request.contextPath}/delete"><span class="glyphicon"></span><fmt:message key="admin.menubar.label.delete"/></a></li>
                </ul>
                <ul class="nav navbar-nav navbar-left">
                    <li><a href="${pageContext.request.contextPath}/edit"><span class="glyphicon"></span><fmt:message key="admin.menubar.label.edit"/></a></li>
                </ul>

                <ul class="nav navbar-nav navbar-left">
                    <li><a href="${pageContext.request.contextPath}/user"><span class="glyphicon"></span><fmt:message key="admin.menubar.label.user_block"/></a></li>
                </ul>
                <ul class="nav navbar-nav navbar-left">
                    <li><a href="${pageContext.request.contextPath}/order_status"><span class="glyphicon"></span><fmt:message key="admin.menubar.label.order_edit"/></a></li>
                </ul>
                <ul class="nav navbar-nav navbar-right">
                    <li><a href="${pageContext.request.contextPath}/logout"><span class="glyphicon glyphicon-log-in"></span>  <fmt:message key="menubar.label.log_out"/></a></li>
                </ul>
            </div>
        </div>
    </nav>
