...
<head>
    <title><fmt:message key="label.delete_product"/></title>
</head>
<body>
<div class="page-form">
    <form action="${pageContext.request.contextPath}/delete" method="post">
        <h2><fmt:message key="label.delete_product"/></h2>
        ...
        <div class="form-group">
            <button type="submit" class="btn btn-success btn-lg btn-block"><fmt:message key="button.delete"/></button>
        </div>
    </form>
</div>
</body>
